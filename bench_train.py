...
MIN_CHUNK_SIZE = 8192
MAX_TOKENS_PER_ROUND_LIMIT=None
...
working_set_config, chosen_hardware_env = determine_working_set_config(model_dims, MAX_SEQ_LEN, MAX_TOKENS_PER_STEP, training_config=training_config, device_id=DEVICE_ID, verbose=True, fixed_seq_len=True, min_chunk_size=MIN_CHUNK_SIZE, max_tokens_per_round_limit=MAX_TOKENS_PER_ROUND_LIMIT, max_gpu_mem_bytes=max_gpu_mem_bytes, max_host_mem_bytes=max_host_mem_bytes)
