                    ...
                    for seq_group_chunk_ind in range(len(seq_group) - 1, -1, -1):
                        ...
                        if next_act_slot_prefetch[0] != -1:
                            ...
                            with self.inbound_stream:
                                ...
                                self.dev_act_slot_mapping[(next_act_pre_layer_id, next_act_pre_chunk_id)] = layer.fetch_activations(self.act_slot_gpu[cur_act_slot_idx], self.cpu_act_slots[(next_act_pre_layer_id, next_act_pre_chunk_id)])
